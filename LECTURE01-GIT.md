...
14. `git pull` will return error conflict
15. edit again [004-hellogitreset.html]((/lecture01-git/004-hellogitreset.html)) in local machine
16. resolve the conflict line then save
17. `git commit -am 'Modified after reset 004-hellogitreset.html'`
18. `git push`
...
03. try to resize the image
04. try to resize the image responsively
